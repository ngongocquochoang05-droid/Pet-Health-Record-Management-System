...
function getAuthCompleteUrl() {
  return window.MyPuppyAuth.appPath("customer/pages/auth/auth-complete.html");
}
...
async function handleGoogleLogin() {
  ...
  try {
    ...
    await clerk.client.signIn.authenticateWithRedirect({
      ...
      redirectUrl: window.MyPuppyAuth.appPath("customer/pages/auth/sso-callback.html"),
  ...
  try {
    ...
    if (isClerkRedirect) {
      ...
      await clerk.handleRedirectCallback({
        ...
        continueSignUpUrl: window.MyPuppyAuth.appPath("customer/pages/auth/sso-continue.html"),
        redirectUrlComplete: getAuthCompleteUrl(),
        transferable: true,
      });
